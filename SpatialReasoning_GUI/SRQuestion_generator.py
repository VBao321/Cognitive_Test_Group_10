...
def random_SRQuestion(shape, colors):
    ...
    cube_arr.fig.savefig(f"./Figures/SRQ_{question_idx}.png", dpi=300, bbox_inches='tight', pad_inches=0)
    ...
    for idx in range(3):
        ...
        cube_arr.fig.savefig(f"./Figures/SRQ_{question_idx}_{option}.png", dpi=300,  bbox_inches='tight', pad_inches=0)
        options.append(f"./Figures/SRQ_{question_idx}_{option}.png")
