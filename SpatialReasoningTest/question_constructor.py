...
class MathsAbilityQuestion(Question):  
    ...
    def __init__(self, description, calc_steps, answer, description_img=None, description_style="color:red; font-size: 30px"):
        """
...
class MemoryQuestion(Question):  
    """
    Represents a Memory Question within a quiz, focusing on spatial reasoning skills.
